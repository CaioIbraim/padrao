...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Jun-2018 às 21:12
...
INSERT INTO `user` (`id_user`, `first_name`, `last_name`, `nick_name`, `cell_phone`, `public_place`, `type_public_place`, `postal_code`, `public_place_number`, `id_state`, `id_religion`) VALUES
(1, 'Caio', 'Ibraim', 'JF$#S**WTG', '+55 21 96863 - 9055', NULL, NULL, NULL, NULL, 0, 39),
(2, 'Yuri', 'Ibraim', 'ATW#SJ@U@D', '+55 21 96863 - 9000', 'Rua Arnaldo Tavares', 1, '24467620', 1818, 0, 1);
